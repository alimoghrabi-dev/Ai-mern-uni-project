        ...
        <div className="fixed bottom-0 border-t border-gray-600/[0.35] w-full flex items-center justify-start py-5 px-4 sm:px-8 md:px-12 bg-accent custom-shadow">
          <div className="flex w-full lg:w-[75%] xl:w-[79%] h-[50px]">
            <Input
              ...
              className="w-full rounded-lg h-full placeholder:text-sm placeholder:font-normal text-gray-50 placeholder:text-gray-400 hover:bg-neutral-900/30 focus:border-gray-300 transition duration-150 border-r-0 rounded-r-none"
            />
            <div
